...
export default function AboutPage() {
  return (
    <main>
      ...
      <PageHero
        eyebrow="About TWKH"
        title={<>Beauty draws us in.<br /><em>Curiosity carries us toward stewardship.</em></>}
        intro="The Well-Kept Habitat uses thoughtful landscape composition with ecological importance to invite future stewards—people who may first be drawn in by beauty."
      ...
      <section className="manifesto-section">
        ...
        <div>
          <h2>A well-kept habitat is elegance arranged in service of life.</h2>
          <p>TWKH does not propose one correct aesthetic for nature. A meadow, woodland edge, untended patch and formally composed native garden can all be thriving habitats. We focus on using thoughtful landscape composition that carries ecological importance to invite future stewards who may first be drawn in by beauty. Attraction opens the door; curiosity, understanding and appreciation make stewardship possible.</p>
        </div>
      </section>
