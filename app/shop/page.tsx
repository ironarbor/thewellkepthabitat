...
export const metadata: Metadata = {
  ...
  description: 'Future TWKH field guides, books, editorial prints and habitat-inspired objects available without a Habitat Assessment.',
};
  ...
  return (
    <main>
      ...
      <section className="shop-boundary-banner">
        <ShoppingBag size={29} />
        <div><p className="kicker">Available to everyone</p><h2>This is the independent Shop.</h2><p>Everything shown here is intended for purchase without a Habitat Assessment. Property-specific photographs and custom habitat portraits remain assessment add-ons under Services.</p></div>
        <a className="text-link" href="/services/habitat-assessments#assessment-addons">See assessment add-ons <ArrowRight size={17} /></a>
      </section>
