    ...
    <main>
      ...
      <section className="consultation-fit">
        ...
        <div className="fit-list">
          ...
          <article><Check size={18} /><p>Understand whether a full Habitat Assessment is the right next step.</p></article>
      ...
      <section className="consultation-compare">
        ...
        <article><Search size={28} /><p className="kicker">Habitat Assessment</p><h2>Comprehensive</h2><p>A structured property visit, documentation process and polished current-state report.</p><a href="/services/habitat-assessments">Explore assessments <ArrowRight size={16} /></a></article>
      </section>
      ...
      <section className="page-next-links">
        ...
        <a href="/services/habitat-assessments">Habitat Assessments <ArrowRight size={17} /></a>
      </section>
      <SiteFooter />
    </main>
  );
